        ...
        listView.setAdapter(new BaseAdapter() {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                ...
                if(convertView==null){
                    ...
                    convertView=LayoutInflater.from(getActivity()).inflate(R.layout.finalproductitem,null);
                ...
                holder.price.setText(datas.get(position).price+"元/个");
